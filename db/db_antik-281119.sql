...
--
-- Host: 127.0.0.1
-- Generation Time: 28 Nov 2019 pada 04.57
...
INSERT INTO `tb_user` (`id_user`, `id_akses`, `no_identitas`, `nama`, `jenis_kelamin`, `tempat_lahir`, `tanggal_lahir`, `no_hp`, `alamat`, `domisili`, `pekerjaan`, `username`, `password`, `foto`) VALUES
(1, 1, '0', '', '', '', '0000-00-00', '', '', '', '', 'admin', 'admin', ''),
(2, 2, 'E31181295', 'Amry Zulfa Al Husna', 'L', 'Kediri', '1999-08-17', '082234121604', 'Jember', 'Kediri', 'Mahasiswa', 'E31181295', 'E31181295', ''),
